...
newNTL_matrix_impl(GF2E,vec_GF2E,vec_vec_GF2E,mat_GF2E)
newNTL_io_matrix_impl(GF2E,vec_GF2E,vec_vec_GF2E,mat_GF2E)
newNTL_eq_matrix_impl(GF2E,vec_GF2E,vec_vec_GF2E,mat_GF2E)
...
mat_GF2E operator+(const mat_GF2E& a, const mat_GF2E& b)
{
   mat_GF2E res;
   add(res, a, b);
   newNTL_OPT_RETURN(mat_GF2E, res);
}
...
vec_GF2E operator*(const mat_GF2E& a, const vec_GF2E& b)
{
   vec_GF2E res;
   mul_aux(res, a, b);
   newNTL_OPT_RETURN(vec_GF2E, res);
}
