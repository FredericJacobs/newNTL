...
newNTL_matrix_impl(zz_p,vec_zz_p,vec_vec_zz_p,mat_zz_p)
newNTL_io_matrix_impl(zz_p,vec_zz_p,vec_vec_zz_p,mat_zz_p)
newNTL_eq_matrix_impl(zz_p,vec_zz_p,vec_vec_zz_p,mat_zz_p)
...
namespaceanon inline vec_long& mul_aux_vec() {
  staticthread vec_long m_mul_aux_vec;
  return m_mul_aux_vec;
}

namespaceanon inline newNTL_SPMM_VEC_T& precon_vec() {
  staticthread newNTL_SPMM_VEC_T m_precon_vec;
  return m_precon_vec;
}
...
mat_zz_p operator+(const mat_zz_p& a, const mat_zz_p& b)
{
   mat_zz_p res;
   add(res, a, b);
   newNTL_OPT_RETURN(mat_zz_p, res);
}
...
vec_zz_p operator*(const mat_zz_p& a, const vec_zz_p& b)
{
   vec_zz_p res;
   mul_aux(res, a, b);
   newNTL_OPT_RETURN(vec_zz_p, res);
}
