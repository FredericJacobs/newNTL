...
void GF2X::SetMaxLength(long n)
{
   ...
   long w = (n + newNTL_BITS_PER_LONG - 1)/newNTL_BITS_PER_LONG;
   xrep.SetMaxLength(w);
}
...
long deg(const GF2X& aa)
{
   ...
   return newNTL_BITS_PER_LONG*(n-1) + i - 1;
}
...
void random(GF2X& x, long n)
{
   ...
   long wl = (n+newNTL_BITS_PER_LONG-1)/newNTL_BITS_PER_LONG;
   ...
   if (n > 0) {
      long pos = n % newNTL_BITS_PER_LONG;
      if (pos == 0) pos = newNTL_BITS_PER_LONG;
...
void add(GF2X& x, const GF2X& a, const GF2X& b)
{
   ...
   if (sa == sb) {
      ...
      _newntl_ulong *xp = x.xrep.elts();
      const _newntl_ulong *ap = a.xrep.elts();
      const _newntl_ulong *bp = b.xrep.elts();
 ...
 * macros newNTL_BB_MUL_CODE... are defined in mach_desc.h.
 * Thanks to Paul Zimmermann for providing improvements
 * to this approach.
 */


#if (defined(newNTL_GF2X_ALTCODE1))

#define newNTL_EFF_BB_MUL_CODE0 newNTL_ALT1_BB_MUL_CODE0
#define newNTL_EFF_BB_MUL_CODE1 newNTL_ALT1_BB_MUL_CODE1
#define newNTL_EFF_BB_MUL_CODE2 newNTL_ALT1_BB_MUL_CODE2
#define newNTL_EFF_SHORT_BB_MUL_CODE1 newNTL_ALT1_SHORT_BB_MUL_CODE1
#define newNTL_EFF_HALF_BB_MUL_CODE0 newNTL_ALT1_HALF_BB_MUL_CODE0

#elif (defined(newNTL_GF2X_ALTCODE))

#define newNTL_EFF_BB_MUL_CODE0 newNTL_ALT_BB_MUL_CODE0
#define newNTL_EFF_BB_MUL_CODE1 newNTL_ALT_BB_MUL_CODE1
#define newNTL_EFF_BB_MUL_CODE2 newNTL_ALT_BB_MUL_CODE2
#define newNTL_EFF_SHORT_BB_MUL_CODE1 newNTL_ALT_SHORT_BB_MUL_CODE1
#define newNTL_EFF_HALF_BB_MUL_CODE0 newNTL_ALT_HALF_BB_MUL_CODE0

#else

#define newNTL_EFF_BB_MUL_CODE0 newNTL_BB_MUL_CODE0
#define newNTL_EFF_BB_MUL_CODE1 newNTL_BB_MUL_CODE1
#define newNTL_EFF_BB_MUL_CODE2 newNTL_BB_MUL_CODE2
#define newNTL_EFF_SHORT_BB_MUL_CODE1 newNTL_SHORT_BB_MUL_CODE1
#define newNTL_EFF_HALF_BB_MUL_CODE0 newNTL_HALF_BB_MUL_CODE0
...
namespaceanon 
void mul1(_newntl_ulong *c, _newntl_ulong a, _newntl_ulong b)
{

newNTL_EFF_BB_MUL_CODE0
...
namespaceanon inline
void mul1_inline(_newntl_ulong *c, _newntl_ulong a, _newntl_ulong b)
{
...
namespaceanon 
void Mul1(_newntl_ulong *cp, const _newntl_ulong *bp, long sb, _newntl_ulong a)
{
 

newNTL_EFF_BB_MUL_CODE1


}

namespaceanon 
void AddMul1(_newntl_ulong *cp, const _newntl_ulong* bp, long sb, _newntl_ulong a)
{


newNTL_EFF_BB_MUL_CODE2
...
namespaceanon 
void Mul1_short(_newntl_ulong *cp, const _newntl_ulong *bp, long sb, _newntl_ulong a)
{
 

newNTL_EFF_SHORT_BB_MUL_CODE1
...
namespaceanon 
void mul_half(_newntl_ulong *c, _newntl_ulong a, _newntl_ulong b)
{


newNTL_EFF_HALF_BB_MUL_CODE0
...
namespaceanon
void mul2(_newntl_ulong *c, const _newntl_ulong *a, const _newntl_ulong *b)
{
   _newntl_ulong hs0, hs1;
   _newntl_ulong hl2[2];
...
namespaceanon
void mul3 (_newntl_ulong *c, const _newntl_ulong *a, const _newntl_ulong *b)
{
   _newntl_ulong d0[2], d1[2], d2[2], d01[2], d02[2], d12[2];
...
namespaceanon
void mul4(_newntl_ulong *c, const _newntl_ulong *a, const _newntl_ulong *b)
{
   _newntl_ulong hs0[2], hs1[2];
   _newntl_ulong hl2[4];
...
namespaceanon
void mul5 (_newntl_ulong *c, const _newntl_ulong *a, const _newntl_ulong *b)
{
   _newntl_ulong hs0[3], hs1[3];
   _newntl_ulong hl2[6];
...
namespaceanon
void mul6(_newntl_ulong *c, const _newntl_ulong *a, const _newntl_ulong *b)
{
   _newntl_ulong hs0[3], hs1[3];
   _newntl_ulong hl2[6];
...
namespaceanon
void mul7(_newntl_ulong *c, const _newntl_ulong *a, const _newntl_ulong *b)
{
   _newntl_ulong hs0[4], hs1[4];
   _newntl_ulong hl2[8];
...
namespaceanon
void mul8(_newntl_ulong *c, const _newntl_ulong *a, const _newntl_ulong *b)
{
   _newntl_ulong hs0[4], hs1[4];
   _newntl_ulong hl2[8];
...
namespaceanon
void KarMul(_newntl_ulong *c, const _newntl_ulong *a, const _newntl_ulong *b, 
            long len, _newntl_ulong *stk)
{
   if (len <= 8) {
      switch (len) {
   ...
   const _newntl_ulong *a0, *a1, *b0, *b1;
   _newntl_ulong *a01, *b01, *h;
...
void mul(GF2X& c, const GF2X& a, const GF2X& b)
{
   ...
   _newntl_ulong a0 = a.xrep[0];
   _newntl_ulong b0 = b.xrep[0];
   ...
   if (sa == 1 && sb == 1) {
      // special case...
      _newntl_ulong v[2];
      if (!(a0 >> newNTL_BITS_PER_LONG/2))
         mul_half(v, b0, a0);
      else if (!(b0 >> newNTL_BITS_PER_LONG/2))
         mul_half(v, a0, b0);
      else
         mul1(v, a0, b0);
   ...
   if (sa == 1) {
      ...
      if (a0 >> (newNTL_BITS_PER_LONG-newNTL_BB_MUL1_BITS+1))
         Mul1(cp, bp, sb, a0);
      else
   ...
   if (sb == 1) {
      ...
      if (b0 >> (newNTL_BITS_PER_LONG-newNTL_BB_MUL1_BITS+1))
         Mul1(cp, ap, sa, b0);
      else
   ...
   const _newntl_ulong *ap = a.xrep.elts(), *bp = b.xrep.elts();
   _newntl_ulong *cp;
...
#endif
{
   ...
   staticthread WordVector mem;
   staticthread WordVector stk;
   staticthread WordVector vec;

   const _newntl_ulong *ap, *bp;
   _newntl_ulong *cp;
   ...
   do {
      ...
      { const _newntl_ulong *t; t = ap; ap = bp + i; bp = t; }
...
void trunc(GF2X& x, const GF2X& a, long m)
{
   ...
   if (&x == &a) {
      if (n*newNTL_BITS_PER_LONG > m) {
         long wm = (m-1)/newNTL_BITS_PER_LONG;
         long bm = m - newNTL_BITS_PER_LONG*wm;
         _newntl_ulong msk;
         if (bm == newNTL_BITS_PER_LONG)
            msk = ~(0UL);
         else
            msk = ((1UL << bm) - 1UL);
         x.xrep[wm] &= msk;
   ...
   else if (n*newNTL_BITS_PER_LONG <= m) 
      x = a;
   else {
      long wm = (m-1)/newNTL_BITS_PER_LONG;
      long bm = m - newNTL_BITS_PER_LONG*wm;
      x.xrep.SetLength(wm+1);
      _newntl_ulong *xp = &x.xrep[0];
      const _newntl_ulong *ap = &a.xrep[0];
      long i;
      for (i = 0; i < wm; i++)
         xp[i] = ap[i];
      _newntl_ulong msk;
...
newNTL_vector_impl(GF2X,vec_GF2X)

newNTL_io_vector_impl(GF2X,vec_GF2X)

newNTL_eq_vector_impl(GF2X,vec_GF2X)
...
void MulByX(GF2X& x, const GF2X& a)
{
   ...
   if (a.xrep[n-1] & (1UL << (newNTL_BITS_PER_LONG-1))) {
   ...
   long i;
   for (i = n-1; i > 0; i--)
      xp[i] = (ap[i] << 1) | (ap[i-1] >> (newNTL_BITS_PER_LONG-1));
...
namespaceanon _newntl_ulong sqrtab[256] = {
...
namespaceanon inline 
void sqr1(_newntl_ulong *c, _newntl_ulong a)
{
   _newntl_ulong hi, lo;
...
void LeftShift(GF2X& c, const GF2X& a, long n)
{
   ...
   if (bn == 0) {
      ...
      cp[sa+wn] = ap[sa-1] >> (newNTL_BITS_PER_LONG-bn);
...
void RightShift(GF2X& c, const GF2X& a, long n)
{
   ...
   if (n < 0) {
      if (n < -newNTL_MAX_LONG) Error("overflow in RightShift");
      LeftShift(c, a, -n);
      return;
   }
...
namespaceanon _newntl_ulong revtab[256] = {
...
namespaceanon inline 
_newntl_ulong rev1(_newntl_ulong a)
{
   return newNTL_BB_REV_CODE;
}
...

{
   ...
   if (bn != 0) {
      for (i = wn-1; i >= 1; i--)
         cp[i] = (cp[i] << bn) | (cp[i-1] >> (newNTL_BITS_PER_LONG-bn));
      cp[0] = cp[0] << bn;
   }

   for (i = 0; i < wn/2; i++) {
      _newntl_ulong t; t = cp[i]; cp[i] = cp[wn-1-i]; cp[wn-1-i] = t;
   }
...
void GF2XFromBytes(GF2X& x, const unsigned char *p, long n)
{
   ...
   const long BytesPerLong = newNTL_BITS_PER_LONG/8;
