...
staticthread vec_zz_pX *BabyStepFile = 0;
staticthread vec_zz_pX *GiantStepFile = 0;
staticthread zz_pXArgument *HHH = 0;
staticthread long OldN = 0;
                       ...
                       long verbose)
{
   ...
   BabyStepFile = newNTL_NEW_OP vec_zz_pX;
...
void GenerateGiantSteps(const zz_pX& f, const zz_pX& h, long l, long verbose)
{
   ...
   HHH = newNTL_NEW_OP zz_pXArgument;
   build(*HHH, h, F, 2*SqrRoot(F.n));

   OldN = F.n;

   GiantStepFile = newNTL_NEW_OP vec_zz_pX;
