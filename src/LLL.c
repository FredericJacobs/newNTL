...
namespaceanon void ExactDiv(ZZ& qq, const ZZ& a, const ZZ& b)
{
   staticthread ZZ q, r;
...
namespaceanon void BalDiv(ZZ& q, const ZZ& a, const ZZ& d)
...
namespaceanon void MulAddDiv(ZZ& c, const ZZ& c1, const ZZ& c2, 
                      const ZZ& x, const ZZ& y, const ZZ& z)

// c = (x*c1 + y*c2)/z

{
   staticthread ZZ t1, t2;
...
namespaceanon void MulSubDiv(ZZ& c, const ZZ& c1, const ZZ& c2, 
                      const ZZ& x, const ZZ& y, const ZZ& z)
...
namespaceanon void MulSubDiv(vec_ZZ& c, const vec_ZZ& c1, const vec_ZZ& c2,
                      const ZZ& x, const ZZ& y, const ZZ& z)
...
namespaceanon void RowTransform(vec_ZZ& c1, vec_ZZ& c2,
...
namespaceanon void RowTransform(ZZ& c1, ZZ& c2,
                         const ZZ& x, const ZZ& y, const ZZ& u, const ZZ& v)
...
namespaceanon void MulSubFrom(vec_ZZ& c, const vec_ZZ& c2, const ZZ& x)
...
namespaceanon void MulSubFrom(vec_ZZ& c, const vec_ZZ& c2, long x)
...
namespaceanon long SwapTest(const ZZ& d0, const ZZ& d1, const ZZ& d2, const ZZ& lam,
                     long a, long b)
...
{
   long i, j;
   staticthread ZZ t1, t2, t3, e, x, y;
