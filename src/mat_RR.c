...
newNTL_matrix_impl(RR,vec_RR,vec_vec_RR,mat_RR)
newNTL_io_matrix_impl(RR,vec_RR,vec_vec_RR,mat_RR)
newNTL_eq_matrix_impl(RR,vec_RR,vec_vec_RR,mat_RR)
...
RR determinant(const mat_RR& a)
   { RR x; determinant(x, a); newNTL_OPT_RETURN(RR, x); }
