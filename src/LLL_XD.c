               ...
               xdouble *c, long k, xdouble bound, long st, xdouble *buf)
{
   ...
   for (j = st; j <= k-1; j++) {
      if (b[k]*b[j] < newNTL_FDOUBLE_PRECISION*newNTL_FDOUBLE_PRECISION) {
         double z = 0;
         xdouble *B1_k = B1[k];
         xdouble *B1_j = B1[j];
