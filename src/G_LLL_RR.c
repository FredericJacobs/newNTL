...
namespaceanon inline RR& red_fudge() {
staticthread RR m_red_fudge;
return m_red_fudge;
}
...
namespaceanon inline vec_RR& G_BKZConstant() {
staticthread vec_RR m_G_BKZConstant;
...
namespaceanon inline vec_RR& G_BKZThresh() {
staticthread vec_RR m_G_BKZThresh;
