...
void BuildIrred(zz_pEX& f, long n)
{
   ...
   if (newNTL_OVERFLOW(n, 1, 0)) Error("overflow in BuildIrred");
...
namespaceanon inline vec_zz_pEX& BabyStepFile() {
  staticthread vec_zz_pEX m_BabyStepFile;
  return m_BabyStepFile;
}

namespaceanon inline vec_zz_pEX& GiantStepFile() {
   staticthread vec_zz_pEX m_GiantStepFile;
   return m_GiantStepFile;
}

staticthread long use_files;
