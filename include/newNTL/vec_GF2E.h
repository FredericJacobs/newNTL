...
#ifndef newNTL_vec_GF2E__H
#define newNTL_vec_GF2E__H

#include <newNTL/GF2E.h>

newNTL_OPEN_NNS

newNTL_vector_decl(GF2E,vec_GF2E)

newNTL_io_vector_decl(GF2E,vec_GF2E)

newNTL_eq_vector_decl(GF2E,vec_GF2E)
...
inline vec_GF2E operator*(const vec_GF2E& a, const GF2E& b)
   { vec_GF2E x; mul(x, a, b); newNTL_OPT_RETURN(vec_GF2E, x); }
...
inline vec_GF2E VectorCopy(const vec_GF2E& a, long n)
   { vec_GF2E x; VectorCopy(x, a, n); newNTL_OPT_RETURN(vec_GF2E, x); }
