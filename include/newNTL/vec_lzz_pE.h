...
#ifndef newNTL_vec_zz_pE__H
#define newNTL_vec_zz_pE__H
...
inline vec_zz_pE VectorCopy(const vec_zz_pE& a, long n)
   { vec_zz_pE x; VectorCopy(x, a, n); newNTL_OPT_RETURN(vec_zz_pE, x); }
...
inline vec_zz_pE operator*(const vec_zz_pE& a, const zz_pE& b)
   { vec_zz_pE x; mul(x, a, b); newNTL_OPT_RETURN(vec_zz_pE, x); }
