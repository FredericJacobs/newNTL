...
#ifndef newNTL_ZZ_pXFactoring__H
#define newNTL_ZZ_pXFactoring__H

#include <newNTL/ZZ.h>
#include <newNTL/ZZ_p.h>
#include <newNTL/ZZ_pX.h>
#include <newNTL/pair_ZZ_pX_long.h>
...
inline ZZ_pX BuildIrred_ZZ_pX(long n)
   { ZZ_pX x; BuildIrred(x, n); newNTL_OPT_RETURN(ZZ_pX, x); }
...
inline ZZ_pX BuildRandomIrred(const ZZ_pX& g)
   { ZZ_pX x; BuildRandomIrred(x, g); newNTL_OPT_RETURN(ZZ_pX, x); }
...
// Space allocation can be controlled via ComposeBound (see <newNTL/ZZ_pX.h>)
