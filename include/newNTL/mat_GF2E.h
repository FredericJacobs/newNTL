...
#ifndef newNTL_mat_GF2E__H
#define newNTL_mat_GF2E__H
...
newNTL_matrix_decl(GF2E,vec_GF2E,vec_vec_GF2E,mat_GF2E)
newNTL_io_matrix_decl(GF2E,vec_GF2E,vec_vec_GF2E,mat_GF2E)
newNTL_eq_matrix_decl(GF2E,vec_GF2E,vec_vec_GF2E,mat_GF2E)
...
inline mat_GF2E ident_mat_GF2E(long n)
   { mat_GF2E X; ident(X, n); newNTL_OPT_RETURN(mat_GF2E, X); }
...
inline mat_GF2E diag(long n, const GF2E& d)
   { mat_GF2E X; diag(X, n, d); newNTL_OPT_RETURN(mat_GF2E, X); }
...
inline mat_GF2E transpose(const mat_GF2E& a)
   { mat_GF2E x; transpose(x, a); newNTL_OPT_RETURN(mat_GF2E, x); }
...
inline mat_GF2E operator*(const mat_GF2E& a, const GF2E& b)
   { mat_GF2E x; mul(x, a, b); newNTL_OPT_RETURN(mat_GF2E, x); }
