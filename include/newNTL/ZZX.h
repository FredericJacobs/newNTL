...
#ifndef newNTL_ZZX__H
#define newNTL_ZZX__H
...
newNTL_SNS istream& operator>>(newNTL_SNS istream& s, ZZX& x);
newNTL_SNS ostream& operator<<(newNTL_SNS ostream& s, const ZZX& a);
...
inline ZZX diff(const ZZX& a)
   { ZZX x; diff(x, a); newNTL_OPT_RETURN(ZZX, x); }
...
template<> inline ZZX to<ZZX>(long a)
   { ZZX x; conv(x, a); newNTL_OPT_RETURN(ZZX, x); }

inline ZZX& ZZX::operator=(long a)
   { conv(*this, a); return *this; }

void conv(ZZX& x, const ZZ& a);
template<> inline ZZX to_ZZX(const ZZ& a)
   { ZZX x; conv(x, a); newNTL_OPT_RETURN(ZZX, x); }
...
template<> inline ZZX to<ZZX>(const vec_ZZ& a)
   { ZZX x; conv(x, a); newNTL_OPT_RETURN(ZZX, x); }

void conv(zz_pX& x, const ZZX& a);
template<> inline zz_pX to<zz_pX>(const ZZX& a)
...
template<> inline ZZX to<ZZX>(const ZZ_pX& a)
   { ZZX x; conv(x, a); newNTL_OPT_RETURN(ZZX, x); }
...
inline ZZX operator+(const ZZX& a, const ZZX& b)
   { ZZX x; add(x, a, b); newNTL_OPT_RETURN(ZZX, x); }
...
inline ZZX operator-(const ZZX& a, const ZZX& b)
   { ZZX x; sub(x, a, b); newNTL_OPT_RETURN(ZZX, x); }
...
inline ZZX operator-(const ZZX& a) 
   { ZZX x; negate(x, a); newNTL_OPT_RETURN(ZZX, x); }
...
inline ZZX sqr(const ZZX& a)
   { ZZX x; sqr(x, a); newNTL_OPT_RETURN(ZZX, x); }
// x = a^2
...
inline ZZX operator*(const ZZX& a, const ZZX& b)
   { ZZX x; mul(x, a, b); newNTL_OPT_RETURN(ZZX, x); }
...
inline ZZX PseudoDiv(const ZZX& a, const ZZX& b)
   { ZZX x; PseudoDiv(x, a, b); newNTL_OPT_RETURN(ZZX, x); }

inline ZZX PseudoRem(const ZZX& a, const ZZX& b)
   { ZZX x; PseudoRem(x, a, b); newNTL_OPT_RETURN(ZZX, x); }
...
inline ZZX operator/(const ZZX& a, const ZZX& b)
   { ZZX x; div(x, a, b); newNTL_OPT_RETURN(ZZX, x); }
...
inline ZZX operator%(const ZZX& a, const ZZX& b)
   { ZZX x; rem(x, a, b); newNTL_OPT_RETURN(ZZX, x); }
...
inline ZZ content(const ZZX& f)
   { ZZ x; content(x, f); newNTL_OPT_RETURN(ZZ, x); }
...
inline ZZX PrimitivePart(const ZZX& f)
   { ZZX x; PrimitivePart(x, f); newNTL_OPT_RETURN(ZZX, x); }
...
inline ZZX GCD(const ZZX& a, const ZZX& b)
   { ZZX x; GCD(x, a, b); newNTL_OPT_RETURN(ZZX, x); }
...
inline vec_ZZ TraceVec(const ZZX& f)
   { vec_ZZ x; TraceVec(x, f); newNTL_OPT_RETURN(vec_ZZ, x); }

void TraceMod(ZZ& res, const ZZX& a, const ZZX& f);
inline ZZ TraceMod(const ZZX& a, const ZZX& f)
   { ZZ x; TraceMod(x, a, f); newNTL_OPT_RETURN(ZZ, x); }
...
inline ZZ resultant(const ZZX& a, const ZZX& b, long deterministic=0)
   { ZZ x; resultant(x, a, b, deterministic); newNTL_OPT_RETURN(ZZ, x); }
...
inline ZZ NormMod(const ZZX& a, const ZZX& f, long deterministic=0)
   { ZZ x; NormMod(x, a, f, deterministic); newNTL_OPT_RETURN(ZZ, x); }
// res = norm of (a mod f)
// f must be monic
// if !deterministic, then it may use a randomized strategy
//    that errs with probability no more than 2^{-80}.
...
inline ZZ discriminant(const ZZX& a, long deterministic=0)
   { ZZ x; discriminant(x, a, deterministic); newNTL_OPT_RETURN(ZZ, x); }
// d = discriminant of a
...
inline ZZX CharPolyMod(const ZZX& a, const ZZX& f, long deterministic=0)
   { ZZX x; CharPolyMod(x, a, f, deterministic); newNTL_OPT_RETURN(ZZX, x); }
...
inline ZZX MinPolyMod(const ZZX& a, const ZZX& f)
   { ZZX x; MinPolyMod(x, a, f); newNTL_OPT_RETURN(ZZX, x); }
...
newNTL_vector_decl(ZZX,vec_ZZX)

newNTL_eq_vector_decl(ZZX,vec_ZZX)

newNTL_io_vector_decl(ZZX,vec_ZZX)
