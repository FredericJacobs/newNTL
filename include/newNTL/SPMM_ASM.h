...
#if (defined (__alpha) && newNTL_BITS_PER_LONG == 64)
...
#if (defined (__ia64) && newNTL_BITS_PER_LONG == 64)
...
#if ((defined (__i386__) || defined (__i486__)) && newNTL_BITS_PER_LONG == 32)
...
#if (defined (__x86_64__) && newNTL_BITS_PER_LONG == 64)
...
#if (defined (__sparc__) && newNTL_BITS_PER_LONG == 32)
