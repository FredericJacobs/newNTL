...
#ifndef newNTL_FFT__H
#define newNTL_FFT__H
...
#define newNTL_FFTMaxRootBnd (newNTL_SP_NBITS-2)
// Absolute maximum root bound for FFT primes.
// Don't change this!

#if (25 <= newNTL_FFTMaxRootBnd)
#define newNTL_FFTMaxRoot (25)
#else
#define newNTL_FFTMaxRoot  newNTL_FFTMaxRootBnd
#endif
