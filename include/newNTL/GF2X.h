...
#ifndef newNTL_GF2X__H
#define newNTL_GF2X__H

#include <newNTL/vector.h>
#include <newNTL/ZZ.h>
#include <newNTL/WordVector.h>
#include <newNTL/vec_GF2.h>
...
newNTL_SNS istream & operator>>(newNTL_SNS istream& s, GF2X& a);

newNTL_SNS ostream& operator<<(newNTL_SNS ostream& s, const GF2X& a);
...
inline GF2X random_GF2X(long n)
   { GF2X x; random(x, n); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X operator+(const GF2X& a, const GF2X& b)
   { GF2X x; add(x, a, b); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X operator-(const GF2X& a, const GF2X& b)
   { GF2X x; sub(x, a, b); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X operator-(const GF2X& a)
   { GF2X x; negate(x, a); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X MulByX(const GF2X& a) 
   { GF2X x; MulByX(x, a); newNTL_OPT_RETURN(GF2X, x); }


void sqr(GF2X& c, const GF2X& a);

inline GF2X sqr(const GF2X& a)
   { GF2X x; sqr(x, a); newNTL_OPT_RETURN(GF2X, x); }

void trunc(GF2X& x, const GF2X& a, long m);
inline GF2X trunc(const GF2X& a, long m)
   { GF2X x; trunc(x, a, m); newNTL_OPT_RETURN(GF2X, x); }


inline GF2X operator*(const GF2X& a, const GF2X& b)
   { GF2X x; mul(x, a, b); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X power(const GF2X& a, long e)
   { GF2X x; power(x, a, e); newNTL_OPT_RETURN(GF2X, x); }



newNTL_vector_decl(GF2X,vec_GF2X)

newNTL_io_vector_decl(GF2X,vec_GF2X)

newNTL_eq_vector_decl(GF2X,vec_GF2X)


void LeftShift(GF2X& c, const GF2X& a, long n);
inline GF2X LeftShift(const GF2X& a, long n)
   {  GF2X x; LeftShift(x, a, n); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X RightShift(const GF2X& a, long n)
   {  GF2X x; RightShift(x, a, n); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X reverse(const GF2X& a, long hi)
   { GF2X x; reverse(x, a, hi); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X reverse(const GF2X& a)
   { GF2X x; reverse(x, a); newNTL_OPT_RETURN(GF2X, x); }

void InvTrunc(GF2X& c, const GF2X& a, long e);


inline GF2X InvTrunc(const GF2X& a, long e)
   { GF2X x; InvTrunc(x, a, e); newNTL_OPT_RETURN(GF2X, x); }
...
public:
   ...
   long posn; //  n - newNTL_BITS_PER_LONG*(sn-1);
   ...
   _newntl_ulong msk; // mask of high bits of residues

   long method; 

   vec_GF2X stab;
   _newntl_ulong **stab_ptr;
   long *stab_cnt;
...
inline GF2X InvMod(const GF2X& a, const GF2X& f)
   { GF2X x; InvMod(x, a, f); newNTL_OPT_RETURN(GF2X, x); } 
...
inline GF2X operator%(const GF2X& a, const GF2XModulus& F)
   { GF2X x; rem(x, a, F); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X operator/(const GF2X& a, const GF2XModulus& F)
   { GF2X x; div(x, a, F); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X operator/(const GF2X& a, const GF2X& b)
   { GF2X x; div(x, a, b); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X operator%(const GF2X& a, const GF2X& b)
   { GF2X x; rem(x, a, b); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X GCD(const GF2X& a, const GF2X& b)
   { GF2X x; GCD(x, a, b); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X diff(const GF2X& a)
   { GF2X x; diff(x, a); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X to_GF2X(long a)
   { GF2X x; conv(x, a); newNTL_OPT_RETURN(GF2X, x); }
...
inline vec_GF2 to_vec_GF2(const GF2X& a)
   { vec_GF2 x; conv(x, a); newNTL_OPT_RETURN(vec_GF2, x); }
...
inline GF2X CompMod(const GF2X& g, 
             const GF2XArgument& A, const GF2XModulus& F)
   { GF2X x; CompMod(x, g, A, F); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X CompMod(const GF2X& g, const GF2X& h, const GF2XModulus& F)
   { GF2X x; CompMod(x, g, h, F); newNTL_OPT_RETURN(GF2X, x); }
...
inline GF2X IrredPolyMod(const GF2X& g, const GF2XModulus& F, long m)
   { GF2X x; IrredPolyMod(x, g, F, m); newNTL_OPT_RETURN(GF2X, x); }
...
inline vec_GF2 UpdateMap(const vec_GF2& a, 
   ...
   { vec_GF2 x; UpdateMap(x, a, B, F); newNTL_OPT_RETURN(vec_GF2, x); }
...
inline vec_GF2 TraceVec(const GF2X& f)
   { vec_GF2 x; TraceVec(x, f); newNTL_OPT_RETURN(vec_GF2, x); }
...
inline GF2X GF2XFromBytes(const unsigned char *p, long n)
   { GF2X x; GF2XFromBytes(x, p, n); newNTL_OPT_RETURN(GF2X, x); }
