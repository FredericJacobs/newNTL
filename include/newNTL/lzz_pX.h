...
#ifndef newNTL_zz_pX__H
#define newNTL_zz_pX__H

#include <newNTL/vector.h>
#include <newNTL/lzz_p.h>
#include <newNTL/vec_lzz_p.h>

newNTL_OPEN_NNS

// some cross-over points

#define newNTL_zz_pX_MOD_CROSSOVER (zz_pX_mod_crossover[zz_pInfo->PrimeCnt])
#define newNTL_zz_pX_MUL_CROSSOVER (zz_pX_mul_crossover[zz_pInfo->PrimeCnt])
#define newNTL_zz_pX_NEWTON_CROSSOVER (zz_pX_newton_crossover[zz_pInfo->PrimeCnt])
#define newNTL_zz_pX_DIV_CROSSOVER (zz_pX_div_crossover[zz_pInfo->PrimeCnt])
#define newNTL_zz_pX_HalfGCD_CROSSOVER (zz_pX_halfgcd_crossover[zz_pInfo->PrimeCnt])
#define newNTL_zz_pX_GCD_CROSSOVER (zz_pX_gcd_crossover[zz_pInfo->PrimeCnt])
#define newNTL_zz_pX_BERMASS_CROSSOVER (zz_pX_bermass_crossover[zz_pInfo->PrimeCnt])
#define newNTL_zz_pX_TRACE_CROSSOVER (zz_pX_trace_crossover[zz_pInfo->PrimeCnt])
...
newNTL_SNS istream& operator>>(newNTL_SNS istream& s, zz_pX& x);
newNTL_SNS ostream& operator<<(newNTL_SNS ostream& s, const zz_pX& a);
...
inline zz_pX random_zz_pX(long n)
   { zz_pX x; random(x, n); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX diff(const zz_pX& a)
   { zz_pX x; diff(x, a); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX reverse(const zz_pX& a, long hi)
   { zz_pX x; reverse(x, a, hi); newNTL_OPT_RETURN(zz_pX, x); }

inline void reverse(zz_pX& c, const zz_pX& a)
{  reverse(c, a, deg(a)); }

inline zz_pX reverse(const zz_pX& a)
   { zz_pX x; reverse(x, a); newNTL_OPT_RETURN(zz_pX, x); }
...
template<> inline zz_pX to<zz_pX>(long a)
   { zz_pX x; conv(x, a); newNTL_OPT_RETURN(zz_pX, x); }


void conv(zz_pX& x, const ZZ& a);

template<> inline zz_pX to<zz_pX>(const ZZ& a)
   { zz_pX x; conv(x, a); newNTL_OPT_RETURN(zz_pX, x); }

void conv(zz_pX& x, zz_p a);

template<> inline zz_pX to<zz_pX>(const zz_p& a)
   { zz_pX x; conv(x, a); newNTL_OPT_RETURN(zz_pX, x); }


void conv(zz_pX& x, const vec_zz_p& a);

template<> inline zz_pX to<zz_pX>(const vec_zz_p& a)
   { zz_pX x; conv(x, a); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX operator+(const zz_pX& a, const zz_pX& b)
   { zz_pX x; add(x, a, b); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX operator-(const zz_pX& a, const zz_pX& b)
   { zz_pX x; sub(x, a, b); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX operator-(const zz_pX& a)
   { zz_pX x; negate(x, a); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX sqr(const zz_pX& a)
   { zz_pX x; sqr(x, a); newNTL_OPT_RETURN(zz_pX, x); }
// x = a^2
...
inline zz_pX operator*(const zz_pX& a, const zz_pX& b)
   { zz_pX x; mul(x, a, b); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX MulTrunc(const zz_pX& a, const zz_pX& b, long n)
   { zz_pX x; MulTrunc(x, a, b, n); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX SqrTrunc(const zz_pX& a, long n)
   { zz_pX x; SqrTrunc(x, a, n); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX power(const zz_pX& a, long e)
   { zz_pX x; power(x, a, e); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX InvTrunc(const zz_pX& a, long m)
   { zz_pX x; InvTrunc(x, a, m); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX operator/(const zz_pX& a, const zz_pX& b)
   { zz_pX x; div(x, a, b); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX operator%(const zz_pX& a, const zz_pX& b)
   { zz_pX x; rem(x, a, b); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX GCD(const zz_pX& a, const zz_pX& b)
   { zz_pX x; GCD(x, a, b); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX operator%(const zz_pX& a, const zz_pXModulus& F)
   { zz_pX x; rem(x, a, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX operator/(const zz_pX& a, const zz_pXModulus& F)
   { zz_pX x; div(x, a, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX PowerMod(const zz_pX& a, const ZZ& e, const zz_pXModulus& F)
   { zz_pX x; PowerMod(x, a, e, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX PowerXMod(const ZZ& e, const zz_pXModulus& F)
   { zz_pX x; PowerXMod(x, e, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX PowerXPlusAMod(zz_p a, const ZZ& e, const zz_pXModulus& F)
   { zz_pX x; PowerXPlusAMod(x, a, e, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX BuildFromRoots(const vec_zz_p& a)
   { zz_pX x; BuildFromRoots(x, a); newNTL_OPT_RETURN(zz_pX, x); }
...
inline vec_zz_p eval(const zz_pX& f, const vec_zz_p& a)
   { vec_zz_p x; eval(x, f, a); newNTL_OPT_RETURN(vec_zz_p, x); }
...
inline zz_pX interpolate(const vec_zz_p& a, const vec_zz_p& b)
   { zz_pX x; interpolate(x, a, b); newNTL_OPT_RETURN(zz_pX, x); }
...
newNTL_vector_decl(zz_pX,vec_zz_pX)

newNTL_eq_vector_decl(zz_pX,vec_zz_pX)

newNTL_io_vector_decl(zz_pX,vec_zz_pX)
...
inline zz_pX CompMod(const zz_pX& g, const zz_pX& h,
                           const zz_pXModulus& F)
   { zz_pX x; CompMod(x, g, h, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX MinPolySeq(const vec_zz_p& a, long m)
   { zz_pX x; MinPolySeq(x, a, m); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX ProbMinPolyMod(const zz_pX& g, const zz_pXModulus& F, long m)
   { zz_pX x; ProbMinPolyMod(x, g, F, m); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX ProbMinPolyMod(const zz_pX& g, const zz_pXModulus& F)
   { zz_pX x; ProbMinPolyMod(x, g, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX MinPolyMod(const zz_pX& g, const zz_pXModulus& F, long m)
   { zz_pX x; MinPolyMod(x, g, F, m); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX MinPolyMod(const zz_pX& g, const zz_pXModulus& F)
   { zz_pX x; MinPolyMod(x, g, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX IrredPolyMod(const zz_pX& g, const zz_pXModulus& F, long m)
   { zz_pX x; IrredPolyMod(x, g, F, m); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX IrredPolyMod(const zz_pX& g, const zz_pXModulus& F)
   { zz_pX x; IrredPolyMod(x, g, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline vec_zz_p TraceVec(const zz_pX& f)
   { vec_zz_p x; TraceVec(x, f); newNTL_OPT_RETURN(vec_zz_p, x); }
...
inline zz_pX CharPolyMod(const zz_pX& a, const zz_pX& f)
   { zz_pX x; CharPolyMod(x, a, f); newNTL_OPT_RETURN(zz_pX, x); }
