...
#ifndef newNTL_mat_zz_pE__H
#define newNTL_mat_zz_pE__H

#include <newNTL/vec_vec_lzz_pE.h>

newNTL_OPEN_NNS

newNTL_matrix_decl(zz_pE,vec_zz_pE,vec_vec_zz_pE,mat_zz_pE)

newNTL_io_matrix_decl(zz_pE,vec_zz_pE,vec_vec_zz_pE,mat_zz_pE)

newNTL_eq_matrix_decl(zz_pE,vec_zz_pE,vec_vec_zz_pE,mat_zz_pE)
...
inline mat_zz_pE ident_mat_zz_pE(long n)
   { mat_zz_pE X; ident(X, n); newNTL_OPT_RETURN(mat_zz_pE, X); }


void determinant(zz_pE& d, const mat_zz_pE& A);
inline zz_pE determinant(const mat_zz_pE& A)
   {  zz_pE d; determinant(d, A); newNTL_OPT_RETURN(zz_pE, d); }
...
inline mat_zz_pE transpose(const mat_zz_pE& A)
   { mat_zz_pE X; transpose(X, A); newNTL_OPT_RETURN(mat_zz_pE, X); }
...
inline mat_zz_pE diag(long n, const zz_pE& d)
   { mat_zz_pE X; diag(X, n, d); newNTL_OPT_RETURN(mat_zz_pE, X); }
...
inline mat_zz_pE operator*(const mat_zz_pE& a, const zz_pE& b)
   { mat_zz_pE x; mul(x, a, b); newNTL_OPT_RETURN(mat_zz_pE, x); }
