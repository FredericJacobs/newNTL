...
#define newNTL_ZZ_pX_FFT_CROSSOVER (20)  
#define newNTL_ZZ_pX_NEWTON_CROSSOVER (45)
#define newNTL_ZZ_pX_DIV_CROSSOVER (90)
#define newNTL_ZZ_pX_HalfGCD_CROSSOVER (25)
#define newNTL_ZZ_pX_GCD_CROSSOVER (180)
#define newNTL_ZZ_pX_BERMASS_CROSSOVER (90)
#define newNTL_ZZ_pX_TRACE_CROSSOVER (90)
...
inline ZZ_p eval(const ZZ_pX& f, const ZZ_p& a)
   { ZZ_p x; eval(x, f, a); newNTL_OPT_RETURN(ZZ_p, x); }
...
inline ZZ_p project(const vec_ZZ_p& a, const ZZ_pX& b)
   {  ZZ_p x; project(x, a, b); newNTL_OPT_RETURN(ZZ_p, x); }
...
inline ZZ_p TraceMod(const ZZ_pX& a, const ZZ_pXModulus& F)
   { ZZ_p x; TraceMod(x, a, F); newNTL_OPT_RETURN(ZZ_p, x); }
