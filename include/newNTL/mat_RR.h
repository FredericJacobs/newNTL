...
#ifndef newNTL_mat_RR__H
#define newNTL_mat_RR__H
...
newNTL_matrix_decl(RR,vec_RR,vec_vec_RR,mat_RR)
newNTL_io_matrix_decl(RR,vec_RR,vec_vec_RR,mat_RR)
newNTL_eq_matrix_decl(RR,vec_RR,vec_vec_RR,mat_RR)
...
inline mat_RR ident_mat_RR(long n)
   { mat_RR X; ident(X, n); newNTL_OPT_RETURN(mat_RR, X); }
...
inline mat_RR diag(long n, const RR& d)
   { mat_RR X; diag(X, n, d); newNTL_OPT_RETURN(mat_RR, X); }
...
inline mat_RR transpose(const mat_RR & a)
   { mat_RR x; transpose(x, a); newNTL_OPT_RETURN(mat_RR, x); }
...
inline mat_RR operator*(const mat_RR& a, const RR& b)
   { mat_RR x; mul(x, a, b); newNTL_OPT_RETURN(mat_RR, x); }
