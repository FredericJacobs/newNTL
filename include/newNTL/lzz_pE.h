...
#ifndef newNTL_zz_pE__H
#define newNTL_zz_pE__H
...
inline zz_pE sqr(const zz_pE& a)
   { zz_pE x; sqr(x, a); newNTL_OPT_RETURN(zz_pE, x); }
...
inline zz_pE inv(const zz_pE& a)
   { zz_pE x; inv(x, a); newNTL_OPT_RETURN(zz_pE, x); }
...
inline zz_pE power(const zz_pE& a, const ZZ& e)
   { zz_pE x; power(x, a, e); newNTL_OPT_RETURN(zz_pE, x); }
...
template<> inline zz_pE to<zz_pE>(const zz_pX& a) 
   { zz_pE x; conv(x, a); newNTL_OPT_RETURN(zz_pE, x); }

template<> inline zz_pE to<zz_pE>(long a) 
   { zz_pE x; conv(x, a); newNTL_OPT_RETURN(zz_pE, x); }

template<> inline zz_pE to<zz_pE>(const zz_p& a) 
   { zz_pE x; conv(x, a); newNTL_OPT_RETURN(zz_pE, x); }

template<> inline zz_pE to<zz_pE>(const ZZ& a) 
   { zz_pE x; conv(x, a); newNTL_OPT_RETURN(zz_pE, x); }
...
inline zz_pE random_zz_pE()
   { zz_pE x; random(x); newNTL_OPT_RETURN(zz_pE, x); }


// ****** input/output

inline newNTL_SNS ostream& operator<<(newNTL_SNS ostream& s, const zz_pE& a)
   { return s << a._zz_pE__rep; }
   
newNTL_SNS istream& operator>>(newNTL_SNS istream& s, zz_pE& x);
...
inline zz_pE operator+(const zz_pE& a, const zz_pE& b) 
   { zz_pE x; add(x, a, b); newNTL_OPT_RETURN(zz_pE, x); }
...
inline zz_pE operator-(const zz_pE& a, const zz_pE& b) 
   { zz_pE x; sub(x, a, b); newNTL_OPT_RETURN(zz_pE, x); }
...
inline zz_pE operator-(const zz_pE& a)
   { zz_pE x; negate(x, a); newNTL_OPT_RETURN(zz_pE, x); } 
...
inline zz_pE operator*(const zz_pE& a, const zz_pE& b) 
   { zz_pE x; mul(x, a, b); newNTL_OPT_RETURN(zz_pE, x); }
...
inline zz_pE operator/(const zz_pE& a, const zz_pE& b) 
   { zz_pE x; div(x, a, b); newNTL_OPT_RETURN(zz_pE, x); }
