...
#ifndef newNTL_GF2EXFactoring__H
#define newNTL_GF2EXFactoring__H

#include <newNTL/GF2EX.h>
#include <newNTL/pair_GF2EX_long.h>
...
inline GF2EX BuildIrred_GF2EX(long n)
   { GF2EX x; BuildIrred(x, n); newNTL_OPT_RETURN(GF2EX, x); }
...
inline GF2EX BuildRandomIrred(const GF2EX& g)
   { GF2EX x; BuildRandomIrred(x, g); newNTL_OPT_RETURN(GF2EX, x); }
...
// Space allocation can be controlled via ComposeBound (see <newNTL/GF2EX.h>)
