...
#ifndef newNTL_ZZ_p__H
#define newNTL_ZZ_p__H
...
public:
   ...
   double **tbl;       // table used for MultiRem; only with newNTL_SINGLE_MUL

   long **tbl1;        // table used for MultiRem; only with newNTL_TBL_REM
...
template<> inline ZZ_p to<ZZ_p>(const ZZ& a)
...
template<> inline ZZ_p to<ZZ_p>(long a)
   { return ZZ_p(INIT_VAL, a); }
...
inline ZZ_p sqr(const ZZ_p& a)
   { ZZ_p x; sqr(x, a); newNTL_OPT_RETURN(ZZ_p, x); }
...
inline ZZ_p inv(const ZZ_p& a)
   { ZZ_p x; inv(x, a); newNTL_OPT_RETURN(ZZ_p, x); }
...
inline ZZ_p operator+(const ZZ_p& a, const ZZ_p& b)
   { ZZ_p x; add(x, a, b); newNTL_OPT_RETURN(ZZ_p, x); }
...
inline ZZ_p operator-(const ZZ_p& a, const ZZ_p& b)
   { ZZ_p x; sub(x, a, b); newNTL_OPT_RETURN(ZZ_p, x); }
...
inline ZZ_p operator*(const ZZ_p& a, const ZZ_p& b)
   { ZZ_p x; mul(x, a, b); newNTL_OPT_RETURN(ZZ_p, x); }
...
inline ZZ_p operator/(const ZZ_p& a, const ZZ_p& b)
   { ZZ_p x; div(x, a, b); newNTL_OPT_RETURN(ZZ_p, x); }
...
inline ZZ_p operator-(const ZZ_p& a)
   { ZZ_p x; negate(x, a); newNTL_OPT_RETURN(ZZ_p, x); }
...
inline ZZ_p power(const ZZ_p& a, const ZZ& e)
   { ZZ_p x; power(x, a, e); newNTL_OPT_RETURN(ZZ_p, x); }
...
inline ZZ_p random_ZZ_p()
   { ZZ_p x; random(x); newNTL_OPT_RETURN(ZZ_p, x); }


// ****** input/output

inline newNTL_SNS ostream& operator<<(newNTL_SNS ostream& s, const ZZ_p& a)
   { return s << a._ZZ_p__rep; }
   
newNTL_SNS istream& operator>>(newNTL_SNS istream& s, ZZ_p& x);
