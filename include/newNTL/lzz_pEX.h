...
#ifndef newNTL_zz_pEX__H
#define newNTL_zz_pEX__H

#include <newNTL/vec_lzz_pE.h>
...
newNTL_SNS istream& operator>>(newNTL_SNS istream& s, zz_pEX& x);
newNTL_SNS ostream& operator<<(newNTL_SNS ostream& s, const zz_pEX& a);
...
inline zz_pEX random_zz_pEX(long n)
   { zz_pEX x; random(x, n); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX diff(const zz_pEX& a)
   { zz_pEX x; diff(x, a);  newNTL_OPT_RETURN(zz_pEX, x); }
// x = derivative of a
...
inline zz_pEX reverse(const zz_pEX& a, long hi)
   { zz_pEX x; reverse(x, a, hi); newNTL_OPT_RETURN(zz_pEX, x); }

inline void reverse(zz_pEX& c, const zz_pEX& a)
{  reverse(c, a, deg(a)); }

inline zz_pEX reverse(const zz_pEX& a)
   { zz_pEX x; reverse(x, a); newNTL_OPT_RETURN(zz_pEX, x); }
...
template<> inline zz_pEX to<zz_pEX>(long a)
   { zz_pEX x; conv(x, a); newNTL_OPT_RETURN(zz_pEX, x); }

template<> inline zz_pEX to<zz_pEX>(const ZZ& a)
   { zz_pEX x; conv(x, a); newNTL_OPT_RETURN(zz_pEX, x); }

template<> inline zz_pEX to<zz_pEX>(const zz_p& a)
   { zz_pEX x; conv(x, a); newNTL_OPT_RETURN(zz_pEX, x); }

template<> inline zz_pEX to<zz_pEX>(const zz_pX& a)
   { zz_pEX x; conv(x, a); newNTL_OPT_RETURN(zz_pEX, x); }

template<> inline zz_pEX to<zz_pEX>(const zz_pE& a)
   { zz_pEX x; conv(x, a); newNTL_OPT_RETURN(zz_pEX, x); }

template<> inline zz_pEX to<zz_pEX>(const vec_zz_pE& a)
   { zz_pEX x; conv(x, a); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX operator+(const zz_pEX& a, const zz_pEX& b)
   { zz_pEX x; add(x, a, b); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX operator-(const zz_pEX& a, const zz_pEX& b)
   { zz_pEX x; sub(x, a, b); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX operator-(const zz_pEX& a) 
   { zz_pEX x; negate(x, a); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX sqr(const zz_pEX& a) 
   { zz_pEX x; sqr(x, a); newNTL_OPT_RETURN(zz_pEX, x); }
// x = a^2
...
inline zz_pEX MulTrunc(const zz_pEX& a, const zz_pEX& b, long n)
   { zz_pEX x; MulTrunc(x, a, b, n); newNTL_OPT_RETURN(zz_pEX, x); }
// x = a * b % X^n

void SqrTrunc(zz_pEX& x, const zz_pEX& a, long n);
inline zz_pEX SqrTrunc(const zz_pEX& a, long n)
   { zz_pEX x; SqrTrunc(x, a, n); newNTL_OPT_RETURN(zz_pEX, x); }
// x = a*a % X^n


inline zz_pEX operator*(const zz_pEX& a, const zz_pEX& b)
   { zz_pEX x; mul(x, a, b); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX power(const zz_pEX& a, long e)
   { zz_pEX x; power(x, a, e); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX InvTrunc(const zz_pEX& a, long m)
   { zz_pEX x; InvTrunc(x, a, m); newNTL_OPT_RETURN(zz_pEX, x); }
// computes x = a^{-1} % X^m 
// constant term must be invertible


inline zz_pEX operator/(const zz_pEX& a, const zz_pEX& b)
   { zz_pEX x; div(x, a, b); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX operator%(const zz_pEX& a, const zz_pEX& b)
   { zz_pEX x; rem(x, a, b); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX GCD(const zz_pEX& a, const zz_pEX& b)
   { zz_pEX x; GCD(x, a, b); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX PowerMod(const zz_pEX& g, const ZZ& e, 
                             const zz_pEXModulus& F)
   { zz_pEX x; PowerMod(x, g, e, F);  newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX PowerXMod(const ZZ& e, const zz_pEXModulus& F)
   { zz_pEX x; PowerXMod(x, e, F);  newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX operator%(const zz_pEX& a, const zz_pEXModulus& F)
   { zz_pEX x; rem(x, a, F); newNTL_OPT_RETURN(zz_pEX, x); }

inline zz_pEX& operator%=(zz_pEX& x, const zz_pEXModulus& F)
   { rem(x, x, F); return x; }

inline zz_pEX operator/(const zz_pEX& a, const zz_pEXModulus& F)
   { zz_pEX x; div(x, a, F); newNTL_OPT_RETURN(zz_pEX, x); }
...
newNTL_vector_decl(zz_pEX,vec_zz_pEX)

newNTL_eq_vector_decl(zz_pEX,vec_zz_pEX)

newNTL_io_vector_decl(zz_pEX,vec_zz_pEX)
...
inline zz_pEX BuildFromRoots(const vec_zz_pE& a)
   { zz_pEX x; BuildFromRoots(x, a); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX interpolate(const vec_zz_pE& a, const vec_zz_pE& b)
   { zz_pEX x; interpolate(x, a, b); newNTL_OPT_RETURN(zz_pEX, x); }
...
CompMod(const zz_pEX& g, const zz_pEX& h, const zz_pEXModulus& F)
   { zz_pEX x; CompMod(x, g, h, F); newNTL_OPT_RETURN(zz_pEX, x); }
// x = g(h) mod f
...
inline zz_pEX MinPolySeq(const vec_zz_pE& a, long m)
   { zz_pEX x; MinPolySeq(x, a, m); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX MinPolyMod(const zz_pEX& g, const zz_pEXModulus& F)
   { zz_pEX x; MinPolyMod(x, g, F); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX MinPolyMod(const zz_pEX& g, const zz_pEXModulus& F, long m)
   { zz_pEX x; MinPolyMod(x, g, F, m); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX ProbMinPolyMod(const zz_pEX& g, const zz_pEXModulus& F)
   { zz_pEX x; ProbMinPolyMod(x, g, F); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX ProbMinPolyMod(const zz_pEX& g, const zz_pEXModulus& F, long m)
   { zz_pEX x; ProbMinPolyMod(x, g, F, m); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX IrredPolyMod(const zz_pEX& g, const zz_pEXModulus& F)
   { zz_pEX x; IrredPolyMod(x, g, F); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX IrredPolyMod(const zz_pEX& g, const zz_pEXModulus& F, long m)
   { zz_pEX x; IrredPolyMod(x, g, F, m); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline vec_zz_pE UpdateMap(const vec_zz_pE& a,
         const zz_pEXTransMultiplier& B, const zz_pEXModulus& F)
   { vec_zz_pE x; UpdateMap(x, a, B, F); newNTL_OPT_RETURN(vec_zz_pE, x); }
...
inline vec_zz_pE ProjectPowers(const vec_zz_pE& a, long k, 
                   const zz_pEXArgument& H, const zz_pEXModulus& F)
   { vec_zz_pE x; ProjectPowers(x, a, k, H, F); newNTL_OPT_RETURN(vec_zz_pE, x); }
...
inline zz_pE project(const vec_zz_pE& a, const zz_pEX& b)
   { zz_pE x; InnerProduct(x, a, b.rep); newNTL_OPT_RETURN(zz_pE, x); }
...
inline zz_pEX CompTower(const zz_pX& g, const zz_pEXArgument& A,
             const zz_pEXModulus& F)
   { zz_pEX x; CompTower(x, g, A, F); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pEX CompTower(const zz_pX& g, const zz_pEX& h,
             const zz_pEXModulus& F)
   { zz_pEX x; CompTower(x, g, h, F); newNTL_OPT_RETURN(zz_pEX, x); }
...
inline zz_pX ProbMinPolyTower(const zz_pEX& g, const zz_pEXModulus& F,
                      long m)
   { zz_pX x; ProbMinPolyTower(x, g, F, m); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX ProbMinPolyTower(const zz_pEX& g, const zz_pEXModulus& F)
   { zz_pX x; ProbMinPolyTower(x, g, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX MinPolyTower(const zz_pEX& g, const zz_pEXModulus& F,
                      long m)
   { zz_pX x; MinPolyTower(x, g, F, m); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX MinPolyTower(const zz_pEX& g, const zz_pEXModulus& F)
   { zz_pX x; MinPolyTower(x, g, F); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX IrredPolyTower(const zz_pEX& g, const zz_pEXModulus& F,
                      long m)
   { zz_pX x; IrredPolyTower(x, g, F, m); newNTL_OPT_RETURN(zz_pX, x); }
...
inline zz_pX IrredPolyTower(const zz_pEX& g, const zz_pEXModulus& F)
   { zz_pX x; IrredPolyTower(x, g, F); newNTL_OPT_RETURN(zz_pX, x); }
